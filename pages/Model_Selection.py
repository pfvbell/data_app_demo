...
# tableName = 'DEMO_LOAD_DATA.PUBLIC.ATTENDANCE_MONTHLY_AVERAGE_MAT'
# df_avg_sf = session.table('DEMO_LOAD_DATA.PUBLIC.ATTENDANCE_MONTHLY_AVERAGE_MAT')
# df_avg = df_avg_sf.toPandas()
...
num_months = st.slider('How many months of training data?', 0, 36)
...
#     assistant_query = st.text_input('How can I help?')
#     # if assistant_query:
#     assistant = client.beta.assistants.create(
#       instructions="You are a Machine Learning Expert. When asked about whether results from different machine learning models are good, try to explain this with data visualizations.",
...
#     assistant_query, ml_assistant_id
# )
#     st.markdown(get_response(thread1))
